...
export const PLAYER_AGES = {
  ...
  p22: 28, // Kyler Murray
  p23: 23, // C.J. Stroud
  p24: 31, // Jameis Winston
  p25: 25, // Tyler Shough
  p26: 41, // Aaron Rodgers
  p27: 32, // Carson Wentz
  p28: 28, // Sam Darnold
  p29: 24, // Bryce Young
  ...
  p55: 27, // Rico Dowdle
  p56: 24, // RJ Harvey
  p57: 22, // TreVeyon Henderson
  p58: 21, // Quinshon Judkins
  p59: 26, // J.K. Dobbins
  p60: 24, // Kenneth Walker III
  p61: 24, // Zach Charbonnet
  p62: 30, // James Conner
  p63: 28, // Tony Pollard
  p64: 25, // Tyrone Tracy Jr.
  p65: 30, // Aaron Jones
  p66: 28, // David Montgomery
  p67: 21, // Audric Estimé
  p68: 30, // Alvin Kamara
  p69: 24, // Kimani Vidal
  p70: 24, // Woody Marks
  p71: 23, // Trey Benson
  p72: 30, // Kareem Hunt
  p73: 24, // Tyjae Spears
  p74: 23, // Kyle Monangai
  p75: 26, // Chuba Hubbard
  p76: 26, // Rachaad White
  p77: 24, // Jacory Croskey-Merritt
  p78: 26, // Jordan Mason
  p79: 24, // Bam Knight
  p80: 25, // Chris Rodriguez Jr.
  p81: 26, // Michael Carter
  p82: 26, // Jawhar Jordan
  p83: 25, // Tyler Allgeier
  p84: 24, // Blake Corum
  p85: 28, // Miles Sanders
  p86: 26, // Isiah Pacheco
  p87: 22, // Devin Neal
  p88: 27, // Justice Hill
  p89: 27, // Devin Singletary
  p90: 29, // Nick Chubb
  p91: 27, // Ty Johnson
  p92: 23, // Bhayshul Tuten
  p93: 20, // Dylan Sampson
  p94: 26, // Emanuel Wilson
  p95: 23, // Sean Tucker
  p96: 22, // Jaylen Wright
  p97: 29, // Samaje Perine
  p98: 23, // Raheim Sanders
  p99: 26, // Emari Demercado
  p100: 23, // Kendre Miller
  p101: 27, // Antonio Gibson
  p102: 29, // Jeremy McNichols
  p103: 23, // Isaiah Davis
  p104: 25, // Jaret Patterson
  p105: 23, // Keaton Mitchell
  p106: 26, // Malik Davis
  p107: 21, // Jaydon Blue
  p108: 27, // Najee Harris
  p109: 24, // Jaleel McLaughlin
  ...
  p146: 28, // Jauan Jennings
  p147: 23, // Parker Washington
  p148: 22, // Emeka Egbuka
  p149: 29, // Terry McLaurin
  p150: 23, // Ladd McConkey
  p151: 28, // Jakobi Meyers
  p152: 33, // Keenan Allen
  p153: 23, // Marvin Harrison Jr.
  p154: 32, // Mike Evans
  p155: 25, // Khalil Shakir
  p156: 22, // Troy Franklin
  p157: 25, // Romeo Doubs
  p158: 28, // DJ Moore
  p159: 22, // Brian Thomas Jr.
  p160: 24, // Ricky Pearsall
  p161: 23, // Jordan Addison
  p162: 25, // Jayden Reed
  p163: 24, // Tre Tucker
  p164: 29, // Chris Godwin Jr.
  p165: 22, // Travis Hunter
  p166: 23, // Kayshon Boutte
  p167: 27, // Rashid Shaheed
  p168: 24, // Josh Downs
  p169: 28, // Marquise Brown
  p170: 24, // Theo Wease Jr.
  p171: 22, // Keon Coleman
  p172: 21, // Luther Burden III
  p173: 23, // Jalen Coker
  p174: 31, // Mack Hollins
  p175: 22, // Tory Horton
  p176: 22, // Xavier Worthy
  p177: 25, // Ryan Flournoy
  p178: 22, // Jayden Higgins
  p179: 23, // Jalen McMillan
  p180: 23, // Chimere Dike
  p181: 27, // Devaughn Vele
  p182: 32, // Cooper Kupp
  p183: 22, // Elic Ayomanor
  p184: 28, // Darius Slayton
  p185: 26, // Jerry Jeudy
  p186: 24, // Malik Washington
  p187: 30, // Calvin Ridley
  p188: 25, // Tyquan Thornton
  p189: 30, // Kendrick Bourne
  ...
  p199: 24, // Sam LaPorta
  p200: 21, // Harold Fannin Jr.
  p201: 35, // Travis Kelce
  p202: 26, // Jake Ferguson
  p203: 23, // Tyler Warren
  p204: 28, // Juwan Johnson
  p205: 30, // Hunter Henry
  p206: 29, // Dalton Schultz
  p207: 25, // Dalton Kincaid
  p208: 21, // Colston Loveland
  p209: 32, // Darren Waller
  p210: 24, // Brenton Strange
  p211: 34, // Zach Ertz
  p212: 26, // Colby Parkinson
  p213: 26, // Jake Tonges
  p214: 22, // Oronde Gadsden II
  p215: 23, // AJ Barner
  p216: 24, // Theo Johnson
  p217: 26, // Cade Otton
  p218: 29, // David Njoku
  p219: 29, // Mark Andrews
  p220: 26, // Pat Freiermuth
  p221: 28, // T.J. Hockenson
  p222: 25, // Chig Okonkwo
  p223: 32, // Tyler Higbee
  p224: 25, // Greg Dulcich
  p225: 21, // Mason Taylor
  p226: 28, // Dawson Knox
  p227: 30, // Evan Engram
  ...
  p232: 30, // Brandon Aubrey
  p233: 30, // Zane Gonzalez
  p234: 24, // Ben Sauls
  p235: 29, // Eddy Pineiro
  p236: 25, // Cameron Dicker
  p237: 24, // Charlie Smyth
  p238: 22, // Cam Little
  p239: 24, // Will Reichard
  p240: 29, // Chase McLaughlin
  p241: 23, // Harrison Mevis
  p242: 25, // Jake Moody
  p243: 34, // Chris Boswell
  p244: 26, // Jake Bates
  p245: 33, // Cairo Santos
  p246: 30, // Harrison Butker
  p247: 22, // Andy Borregales
  p248: 24, // Tyler Loop
  p249: 29, // Joey Slye
  p250: 34, // Brandon McManus
  p251: 26, // Blake Grupe
  p252: 26, // Evan McPherson
  p253: 40, // Nick Folk
  p254: 31, // Wil Lutz
  p255: 38, // Graham Gano
  p256: 25, // Riley Patterson
  p257: 31, // Matt Gay
  p258: 25, // Chad Ryland
